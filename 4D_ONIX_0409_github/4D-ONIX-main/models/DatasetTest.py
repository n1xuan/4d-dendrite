...
class TestDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, opt):
        ...
        # Load images
        images = np.load(path)  # For ph+att: [dataset_size, num_projections, 2, H, W], otherwise [dataset_size, num_projections, H, W]
    ...
    def generate_poses(self):
        # ProjAngles = np.linspace(0.0, 23.86 * 8, 9)  # NB: Modify this part to match the experimental setup
        
        print("Test Poses: 0.0, 90.0")
