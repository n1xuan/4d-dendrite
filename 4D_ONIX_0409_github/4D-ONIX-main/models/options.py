...
class ParamOptions:
    ...
    def initialize(self, parser):
        parser.add_argument(
            "--in_channel",
            type=int,
            default=1, # match experimental channel
        ...
        parser.add_argument(
            "--num_random_rays", type=int, default=4096, help="Number of rays"
        )
        parser.add_argument(
            "--num_encoding_fn_xyz",
            type=int,
        ...
        parser.add_argument(
            "--d_out", type=int, default=1, help="Number of MLP output layers."
        )
        parser.add_argument(
            "--combine_layer",
            type=int,
        ...
        # 验证集的视角索引，默认为0和1，即使用第0和第1个视角进行验证（0：0°；1：90°）。如果有更多视角，可以通过逗号分隔的字符串指定，例如'0, 1, 2'
        parser.add_argument(
            "--val_idx",
            type=int,
            default=0,
